 ...
 * @author nonek
 */
public class MaterialTableRenderer extends JLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        for(int i=0;i<tcm.getColumnCount();i++){
            ...
            label.setText(ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.MATERIAL.toString())[i]);
            tc.setHeaderValue(ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.MATERIAL.toString())[i]);
        }
        ...
        if(row!=-1){
            ...
            if(value instanceof Integer || value instanceof Double) {
                if (column == 1) {
                    etiqueta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/table/material.png")));
            ...
            etiqueta.setToolTipText("Columna "+ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.MATERIAL.toString())[column]);
        }
