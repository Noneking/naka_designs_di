 ...
 * @author nonek
 */
public class ProductTableRenderer extends JLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        for(int i=0;i<tcm.getColumnCount();i++){
            ...
            label.setText(ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.PRODUCT.toString())[i]);
            tc.setHeaderValue(ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.PRODUCT.toString())[i]);
        }
        ...
        if(row!=-1){
            ...
            etiqueta.setToolTipText("Columna "+ColumnModel.getColumnModel(ColumnModel.COLUMN_MODEL_POSITION.PRODUCT.toString())[column]);
        }
